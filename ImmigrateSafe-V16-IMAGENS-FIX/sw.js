const CACHE="immigratesafe-v8-lang-ai";
const ASSETS=["./","./index.html","./styles.css?v=8-LANG-AI","./app.js?v=8-LANG-AI","./manifest.webmanifest","./assets/logo.png","./assets/icon-192.png","./assets/icon-512.png","./assets/icon-1024.png"];
